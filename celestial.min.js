...
! function() {
    ...
    function L(t) {
        ...
        x.selectAll("option").data(j).enter().append("option").attr("value", function(t) {
            ...
            return t.n
        }), x.property("selectedIndex", T), T = 0, w.append("label").attr("title", "Coordinate space in which the map is displayed").attr("for", "transform").html("الإحداثيات"), x = w.append("select").attr("id", "transform").on("change", n), j = Object.keys(g).map(function(t, e) {
        ...
        for (var A in P)
            if (k(P, A)) {
                ...
                I.length > 1 ? (w.append("label").attr("for", "stars-" + A).html("إظهار"), T = 0, w.append("label").attr("title", "Type of star name").attr("id", "label-propername").attr("for", "stars-" + A + "Type").html(function() {
                    return "propername" === A ? "الأسماء العربية" : ""
                    ...
                    return t.n
                }), x.property("selectedIndex", T), w.append("input").attr("type", "checkbox").attr("id", "stars-" + A).property("checked", m.stars[A]).on("change", d)) : 1 === I.length && (w.append("label").attr("for", "stars-" + A).html(" " + P[A][I[0]]), w.append("input").attr("type", "checkbox").attr("id", "stars-" + A).property("checked", m.stars[A]).on("change", d)), w.append("label").attr("for", "stars-" + A + "Limit").html("وصولًا إلى القدر"), w.append("input").attr("type", "number").attr("id", "stars-" + A + "Limit").attr("title", "Star name display limit (magnitude)").attr("value", m.stars[A + "Limit"]).attr("max", "6").attr("min", "-1").attr("step", "0.1").on("change", d)
        ...
        for (A in P)
            if (k(P, A)) {
                ...
                w.append("label").attr("for", "dsos-" + A).html("إظهار"), T = 0, w.append("label").attr("title", "Type of DSO name").attr("for", "dsos-" + A + "Type").attr("class", "advanced").html(""), x = w.append("select").attr("id", "dsos-" + A + "Type").attr("class", "advanced").on("change", d), j = q.map(function(t, e) {
                    return t === m.stars[A + "Type"] && (T = e), {
                        o: t,
                        n: P[A][t]
                    }
                    ...
                    return t.n
                }), x.property("selectedIndex", T), w.append("label").attr("for", "dsos-" + A).html("الأسماء"), w.append("input").attr("type", "checkbox").attr("id", "dsos-" + A).property("checked", m.dsos[A]).on("change", d)
            } w.append("label").attr("for", "dsos-nameLimit").html("وصولًا إلى القدر"), w.append("input").attr("type", "number").attr("id", "dsos-nameLimit").attr("title", "DSO name display limit (magnitude)").attr("value", m.dsos.nameLimit).attr("max", "6").attr("min", "0").attr("step", "0.1").on("change", d), w.append("br"), w.append("label").attr("for", "dsos-size").attr("class", "advanced").html("DSO symbol size: (base"), w.append("input").attr("type", "number").attr("id", "dsos-size").attr("class", "advanced").attr("title", "Size of the displayed symbol: base").attr("value", m.dsos.size).attr("max", "100").attr("min", "0").attr("step", "0.1").on("change", d), w.append("label").attr("for", "dsos-exponent").attr("class", "advanced").html(" * 2 [* adaptation] - magnitude) ^ exponent"), w.append("input").attr("type", "number").attr("id", "dsos-exponent").attr("class", "advanced").attr("title", "Size of the displayed symbol; exponent").attr("value", m.dsos.exponent).attr("max", "3").attr("min", "-1").attr("step", "0.01").on("change", d), D(W("dsos-show")), w = b.append("div").attr("class", "col").attr("id", "constellations"), w.append("label").attr("class", "header").html("الكوكبات"), P = zt.constellations[m.culture] || zt.constellations.iau;
        for (A in P)
            if (k(P, A)) {
                var L = Object.keys(P[A]);
                L.length > 1 ? (w.append("label").attr("for", "constellations-" + A).html("إظهار"), T = 0, w.append("label").attr("title", "Language of constellation names").attr("for", "constellations-" + A + "Type").attr("class", "advanced").html(""), x = w.append("select").attr("id", "constellations-" + A + "Type").attr("class", "advanced").on("change", d), j = L.map(function(t, e) {
                    ...
                    return t.n
                }), x.property("selectedIndex", T), w.append("label").attr("for", "constellations-" + A).html("الأسماء"), w.append("input").attr("type", "checkbox").attr("id", "constellations-" + A).property("checked", m.constellations[A]).on("change", d)) : 1 === L.length && (w.append("label").attr("for", "constellations-" + A).attr("class", "advanced").html(" " + P[A][L[0]]), w.append("input").attr("type", "checkbox").attr("id", "constellations-" + A).attr("class", "advanced").property("checked", m.constellations[A]).on("change", d))
            } w.append("label").attr("for", "constellations-lines").html(" الخطوط"), w.append("input").attr("type", "checkbox").attr("id", "constellations-lines").property("checked", m.constellations.lines).on("change", d), w.append("label").attr("for", "constellations-bounds").html(" الحدود"), w.append("input").attr("type", "checkbox").attr("id", "constellations-bounds").property("checked", m.constellations.bounds).on("change", d), D(W("constellations-names")), w = b.append("div").attr("class", "col").attr("id", "lines"), w.append("label").attr("class", "header").html("الخطوط"), w.append("label").attr("title", "Latitude/longitude grid lines").attr("for", "lines-graticule").html("تمثيل شبكي"), w.append("input").attr("type", "checkbox").attr("id", "lines-graticule-show").property("checked", m.lines.graticule.show).on("change", d), w.append("label").attr("for", "lines-equatorial").html("خط الإستواء"), w.append("input").attr("type", "checkbox").attr("id", "lines-equatorial-show").property("checked", m.lines.equatorial.show).on("change", d), w.append("label").attr("for", "lines-ecliptic").html("مسار الشمس"), w.append("input").attr("type", "checkbox").attr("id", "lines-ecliptic-show").property("checked", m.lines.ecliptic.show).on("change", d), w.append("label").attr("for", "lines-galactic").html("المستوى المجري"), w.append("input").attr("type", "checkbox").attr("id", "lines-galactic-show").property("checked", m.lines.galactic.show).on("change", d), w.append("label").attr("for", "lines-supergalactic").html("المستوى فوق المجري"), w.append("input").attr("type", "checkbox").attr("id", "lines-supergalactic-show").property("checked", m.lines.supergalactic.show).on("change", d), w = b.append("div").attr("class", "col").attr("id", "other"), w.append("label").attr("class", "header").html("أخرى"), w.append("label").attr("for", "mw-show").html("درب التبانة"), w.append("input").attr("type", "checkbox").attr("id", "mw-show").property("checked", m.mw.show).on("change", d), w.append("label").attr("for", "mw-style-fill").attr("class", "advanced").html(" اللون"), w.append("input").attr("type", "color").attr("id", "mw-style-fill").attr("class", "advanced").attr("title", "Milky Way color").attr("value", m.mw.style.fill).on("change", d), w.append("label").attr("for", "mw-style-opacity").attr("class", "advanced").html(" الشفافية"), w.append("input").attr("type", "number").attr("id", "mw-style-opacity").attr("class", "advanced").attr("title", "Transparency of each Milky Way layer").attr("value", m.mw.style.opacity).attr("max", "1").attr("min", "0").attr("step", "0.01").on("change", d), w.append("label").attr("for", "advanced").html("خيارات متقدمة"), w.append("input").attr("type", "checkbox").attr("id", "advanced").property("checked", m.advanced).on("change", d), w.append("br"), w.append("label").attr("for", "background-fill").html("لون الخلفية"), w.append("input").attr("type", "color").attr("id", "background-fill").attr("title", "Background color").attr("value", m.background.fill).on("change", d), w.append("label").attr("for", "background-opacity").attr("class", "advanced").html("الشفافية"), w.append("input").attr("type", "number").attr("id", "background-opacity").attr("class", "advanced").attr("title", "Background opacity").attr("value", m.background.opacity).attr("max", "1").attr("min", "0").attr("step", "0.01").on("change", d), w.append("label").attr("title", "Star/DSO sizes are increased with higher zoom-levels").attr("for", "adaptable").attr("class", "advanced").html("أحجام الأجسام متكيفة"), w.append("input").attr("type", "checkbox").attr("id", "adaptable").attr("class", "advanced").property("checked", m.adaptable).on("change", d);
        var F = St[m.culture];
        T = 0, w.append("label").attr("title", "General language setting").attr("for", "lang").html("أسماء الأجسام "), x = w.append("select").attr("id", "lang").on("change", d), j = F.map(function(t, e) {
            return t === m.lang && (T = e), {
                o: t,
            ...
            return t.n
        }), x.property("selectedIndex", T), w = b.append("div").attr("class", "col").attr("id", "download"), w.append("label").attr("class", "header").html("التحميل"), w.append("input").attr("type", "button").attr("id", "download-png").attr("value", "صورة PNG").on("click", function() {
    ...
    function V(t) {
        ...
        M.append("label").attr("title", "Location coordinates long/lat").attr("for", "lat").html("الموقع"), M.append("input").attr("type", "number").attr("id", "lat").attr("title", "Latitude").attr("placeholder", "Latitude").attr("max", "90").attr("min", "-90").attr("step", "0.0001").attr("value", u[0]).on("change", function() {
            !0 === _(this) && l()
            ...
            !0 === _(this) && l()
        }), M.append("span").html("°"), "geolocation" in navigator && M.append("input").attr("type", "button").attr("value", "موقعي").attr("id", "here").on("click", a), M.append("label").attr("title", "Local date/time").attr("for", "datetime").html(" التاريخ والزمن"), M.append("input").attr("type", "button").attr("id", "day-left").attr("title", "One day back").on("click", function() {
            ...
            if (k(S, j)) {
                ...
                if (A.length > 1) {
                    ...
                    L.selectAll("option").data(F).enter().append("option").attr("value", function(t) {
                        ...
                        return t.n
                    }), L.property("selectedIndex", q), "names" === j && (L.attr("class", "advanced"), M.append("label").attr("for", "planets-" + j).html("الأسماء"), M.append("input").attr("type", "checkbox").attr("id", "planets-" + j).property("checked", y.planets[j]).on("change", i))
                }
